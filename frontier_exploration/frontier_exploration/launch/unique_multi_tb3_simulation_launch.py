...
def generate_launch_description():
    ...
    robots = [
        {"name": "robot1", "x_pose": 1.0, "y_pose": 3.0, "z_pose": 0.01, "roll": 0.0, "pitch": 0.0, "yaw": 0.0},
        {"name": "robot2", "x_pose": 0.0, "y_pose": -3.0, "z_pose": 0.01, "roll": 0.0, "pitch": 0.0, "yaw": 0.0},
    ]
    ...
    declare_robot1_params_file_cmd = DeclareLaunchArgument(
        "robot1_params_file",
        default_value=os.path.join(package_dir, "params", "nav2_multirobot_params_1.yaml"),
        description="Full path to the ROS2 parameters file to use for robot1 launched nodes",
    )

    declare_robot2_params_file_cmd = DeclareLaunchArgument(
        "robot2_params_file",
        default_value=os.path.join(package_dir, "params", "nav2_multirobot_params_2.yaml"),
