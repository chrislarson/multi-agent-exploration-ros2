    ...
    bringup_cmd_group = GroupAction(
        [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(os.path.join(launch_dir_2, "slam_launch.py")),
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(os.path.join(launch_dir_2, "localization_launch.py")),
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(os.path.join(launch_dir_2, "navigation_launch.py")),
                launch_arguments={
                    "namespace": namespace,
                    "use_sim_time": use_sim_time,
                    "autostart": autostart,
